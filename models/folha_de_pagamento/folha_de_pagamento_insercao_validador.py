...
class FolhaDePagamentoValidator(BaseValidatorIns):
    def __init__(self, df):
        super().__init__(df)
        self.config = CONFIGURACOES_MODULOS['modulo_folha_de_pagamento']
...
RegistryValidators.register_ins('modulo_folha_de_pagamento', FolhaDePagamentoValidator)